...
function showperpage($sql, $href, $per_page = 10, $paramType = "", $paramValue = [])
{
    require_once __DIR__ . '/DataSource.php';
    $db_handle = new DataSource();
    $count = $db_handle->getRecordCount($sql, $paramType, $paramValue);
    $perpage = perpage($count, $href, $per_page);
    return $perpage;
}
?>